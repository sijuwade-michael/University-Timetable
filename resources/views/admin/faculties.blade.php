...
<div class="row">
    <div class="col-12">
        <div class="flex-shrink-0 mb-3">
            <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#addFaculty">Add Faculty</button>
        </div>
                    ...
                    <tbody>
                        @foreach ($faculties as $faculty)
                            <tr>
                                <td>{{ $faculty->name }}</td>
                                <td>
                                    <button class="btn btn-sm btn-info" data-bs-toggle="modal" data-bs-target="#editFaculty{{ $faculty->id }}">Edit</button>
                                    <button class="btn btn-sm btn-danger" data-bs-toggle="modal" data-bs-target="#deleteFaculty{{ $faculty->id }}">Delete</button>
                                </td>
                            </tr>
...
<div class="modal fade" id="addFaculty" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-centered modal-lg">
        <form action="{{ url('/admin/newFaculty') }}" method="POST">
            @csrf
            <div class="modal-content">
                <div class="modal-header">
