...
<div class="py-3 d-flex align-items-sm-center flex-sm-row flex-column">
    <div class="flex-grow-1">
        <h4 class="fs-18 fw-semibold m-0">Lecturers</h4>
    </div>
                ...
                <table id="key-table" class="table table-bordered dt-responsive nowrap">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ $lecturer->lastname .  ' ' . $lecturer->othernames }}</td>
                            <td>
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text" name="othernames" class="form-control" value="{{ $lecturer->othernames }}" required>
                                            </div>
                                        </div>
                            ...
                            <div class="modal-dialog  modal-dialog-centered modal-lg">
                                <div class="modal-content">
                                    <div class="modal-body text-center p-4">
                                        ...
                                        <h5 class="my-4">Are you sure you want to delete <br><strong>{{ $lecturer->title }} {{ $lecturer->lastname }} {{ $lecturer->othernames }}</strong>?</h5>
